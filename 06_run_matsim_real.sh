...
echo "[$(date --iso-8601=seconds)] Starting MATSim: 06x_stage1_md_internal/config_real.xml"
...
/usr/bin/time -f "matsim elapsed: %E" mvn -f 06_matsim/pom.xml exec:java \
  -Dexec.args="06x_stage1_md_internal/config_real.xml" \
  2>&1 | tee 06x_stage1_md_internal/matsim_real.log

echo "[$(date --iso-8601=seconds)] Finished MATSim: 06x_stage1_md_internal/config_real.xml"
