...
`paper_wctr_1m_vae_sweep` run. The random seed is `20260731` and the eligible observed-survey
universe contains 35,934 unique directed OD pairs.
...
978 displayed boundaries and 1,683
